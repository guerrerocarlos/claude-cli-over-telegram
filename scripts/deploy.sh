...
service_name="${SERVICE_NAME:-claude-cli-over-telegram}"
service_user="${SERVICE_USER:-gnu}"
service_group="${SERVICE_GROUP:-gnu}"
app_dir="${APP_DIR:-/home/gnu/claude-cli-over-telegram}"
env_dir="${ENV_DIR:-/etc/claude-cli-over-telegram}"
state_dir="${STATE_DIR:-/home/gnu/.local/state/claude-cli-over-telegram}"
health_url="${HEALTH_URL:-http://127.0.0.1:8787/health}"
env_file_source="${ENV_FILE_SOURCE:-}"
unit_source="${UNIT_SOURCE:-deploy/systemd/claude-cli-over-telegram.service}"
